...
| **gemini-3-pro-preview** | "The Context King" | 1M+ token window, deep cross-file analysis | ~$1.25 | Health Dashboard, Milestone Lifecycle |
...
┌─────────────────────────────────────────────────────────────┐
│ gemini-3-pro-preview System Prompt Template                         │
│                                                             │
...
| gemini-3-pro-preview | Small context windows, sequential tool calls, single-document analysis | Gemini's value is the 1M window. Artificially constraining context wastes the advantage. |
