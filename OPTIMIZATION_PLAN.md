...
| **claude-haiku-4.5** | "The Context King" | 1M+ token window, deep cross-file analysis | ~$1.25 | Health Dashboard, Milestone Lifecycle |
...
┌─────────────────────────────────────────────────────────────┐
│ claude-haiku-4.5 System Prompt Template                         │
│                                                             │
...
| claude-haiku-4.5 | Small context windows, sequential tool calls, single-document analysis | Gemini's value is the 1M window. Artificially constraining context wastes the advantage. |
